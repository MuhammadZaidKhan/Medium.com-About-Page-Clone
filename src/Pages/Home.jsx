...
const Home = () => {
    return (
        <div className='min-h-screen bg-amber-400'>
            <div className='flex flex-col pl-16 pt-20 fixed'>
            ...
            <button className='mt-10 px-8 py-3 ml-20 rounded-md bg-black text-white inline-block'>Explore Articles</button>
        </div>
    );
}
